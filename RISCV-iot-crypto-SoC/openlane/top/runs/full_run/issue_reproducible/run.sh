...
export CURRENT_DEF='./tmp/cts/17-top.resized.def';
export CURRENT_NETLIST='./tmp/cts/17-top.resized.nl.v';
export CURRENT_ODB='./tmp/cts/17-top.resized.odb';
export CURRENT_POWERED_NETLIST='./tmp/cts/17-top.resized.pnl.v';
...
export PACKAGED_SCRIPT_0='home/divya/OpenLane/scripts/openroad/resizer_routing_design.tcl';
export PACKAGED_SCRIPT_1='home/divya/OpenLane/scripts/openroad/common/io.tcl';
export PACKAGED_SCRIPT_2='home/divya/OpenLane/scripts/openroad/common/resizer.tcl';
export PACKAGED_SCRIPT_3='home/divya/OpenLane/scripts/openroad/common/set_routing_layers.tcl';
export PACKAGED_SCRIPT_4='home/divya/OpenLane/scripts/openroad/common/set_layer_adjustments.tcl';
export PACKAGED_SCRIPT_5='home/divya/OpenLane/scripts/openroad/common/set_rc.tcl';
export PACKAGED_SCRIPT_6='home/divya/OpenLane/scripts/openroad/common/dpl_cell_pad.tcl';
export PACKAGED_SCRIPT_7='home/divya/RISCV-iot-crypto-SoC/openlane/top/top.sdc';
export PACKAGED_SCRIPT_8='./tmp/18-top.sdc';
export PACKAGED_SCRIPT_9='home/divya/OpenLane/scripts/openroad/common/set_global_connections.tcl';
export PNR_SDC_FILE='home/divya/RISCV-iot-crypto-SoC/openlane/top/top.sdc';
...
export SAVE_DEF='./tmp/18-top.def';
export SAVE_NETLIST='./out.v';
export SAVE_ODB='./tmp/18-top.odb';
export SAVE_POWERED_NETLIST='./tmp/18-top.pnl.v';
export SAVE_SDC='./tmp/18-top.sdc';
export SCRIPTS_DIR='home/divya/OpenLane/scripts';
export SIGNOFF_SDC_FILE='home/divya/RISCV-iot-crypto-SoC/openlane/top/top.sdc';
